  ...
  Future checkFirstSeen() async {
    ...
    if (_introSeen) {
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => const MyHomePage(title: 'Measuring')),
      );
    } else {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  String currentDate2String = dateFormat.format(currentDate);
                  patient_info new_patient = new patient_info(
                      firstname, lastname, int(mhr), currentDate2String);
                  new_patient.insert_patient_info(new_patient);
                  doctor_info new_doctor =
                      new doctor_info(email, currentDate2String);
                  new_doctor.insert_doctor_info(new_doctor);
                },
              ...
              child: RaisedButton(
                onPressed: () {
                  Navigator.of(context)
                      .push(MaterialPageRoute(builder: (context) => PhyAct()));
                  //Navigator.push(
                  //context,
            ...
            FlatButton(
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const MyHomePage(title: 'Measuring')),
                );
              },
              child: Column(
                children: <Widget>[
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  ...
                  messages new_message =
                      new messages(messagetodoctor, currentDate2String);
                  new_message.insert_message(new_message);
                },
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ExplainSympts()),
                  );
                },
                child: Row(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                child: const Text(
                  'Go back and record your symptoms',
                  style: TextStyle(fontSize: 20),
                  textAlign: TextAlign.center,
                ),
              ),
